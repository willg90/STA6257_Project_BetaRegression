...
|                |                |                | score of 340   |
+----------------+----------------+----------------+----------------+
| TOEFL Scores   | to efl_score   | 92 - 120       | Measures       |
|                |                |                | English        |
|                |                | (120 scale)    | language       |
|                |                |                | proficiency,   |
|                |                |                | scored out of  |
...
|                |                |                | points         |
+----------------+----------------+----------------+----------------+
| Un iversity    | universi       | 1 to 5 with 5  | Rates          |
| Rating         | ty_rating      | being the      | universities   |
|                |                | highest rating | on a scale     |
|                |                |                | from 1 to 5,   |
|                |                |                | indicating     |
|                |                |                | their overall  |
|                |                |                | quality and    |
|                |                |                | reputation.    |
+----------------+----------------+----------------+----------------+
| S tatement of  | sop            | 1 to 5 with 5  | Evaluates the  |
| Purpose (SOP)  |                | being the      | strength and   |
| Strength       |                | highest rating | quality of a   |
|                |                |                | candidate's    |
|                |                |                | SOP on a scale |
|                |                |                | of 1 to 5      |
+----------------+----------------+----------------+----------------+
| Letter of      | lor            | 1 to 5 with 5  | Evaluates the  |
| Reccomm        |                | being the      | strength and   |
| endation (LOR) |                | highest rating | quality of a   |
| Strength       |                |                | candidate's    |
|                |                |                | SOP and LOR on |
|                |                |                | a scale of 1   |
|                |                |                | to 5           |
+----------------+----------------+----------------+----------------+
| Under graduate | cgpa           | 6.8 - 9.92     | Reflects a     |
| GPA            |                |                | student's      |
|                |                | (10.0 scale)   | academic       |
|                |                |                | performance in |
|                |                |                | their          |
...
|                |                |                | 10-point scale |
+----------------+----------------+----------------+----------------+
| Research Ex    | research       | 0 or 1         | Indicates      |
| perience       |                |                | whether a      |
|                |                |                | candidate has  |
|                |                |                | research       |
|                |                |                | experience (1) |
...
| Admit          | \_of_admit     |                | likelihood of  |
|                |                | (0 to 1 scale) | a student      |
|                |                |                | being          |
|                |                |                | admitted,      |
|                |                |                | expressed as a |
|                |                |                | decimal        |
