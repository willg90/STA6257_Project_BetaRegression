...
| Rating      | ty_rating   | 5 being the | u           |
|             |             | highest     | niversities |
|             |             | rating      | on a scale  |
|             |             |             | from 1 to   |
|             |             |             | 5,          |
...
|             |             |             | reputation. |
+-------------+-------------+-------------+-------------+
| S tatement  | sop         | 1 to 5 with | Evaluates   |
| of Purpose  |             | 5 being the | the         |
| (SOP)       |             | highest     | strength    |
| Strength    |             | rating      | and quality |
|             |             |             | of a        |
|             |             |             | candidate's |
|             |             |             | SOP on a    |
|             |             |             | scale of 1  |
|             |             |             | to 5        |
+-------------+-------------+-------------+-------------+
| Letter of   | lor         | 1 to 5 with | Evaluates   |
| Reccomm     |             | 5 being the | the         |
| endation    |             | highest     | strength    |
| (LOR)       |             | rating      | and quality |
| Strength    |             |             | of a        |
|             |             |             | candidate's |
|             |             |             | SOP and LOR |
|             |             |             | on a scale  |
...
|             |             |             | (0).        |
+-------------+-------------+-------------+-------------+
| Chance of   | chance\     | 0.34 - 0.97 | Represents  |
| Admit       | \_of_admit  |             | the         |
|             |             | (0 to 1     | likelihood  |
|             |             | scale)      | of a        |
|             |             |             | student     |
...
| Distribution | continuous and bounded        |              |
| of Dependent | between 0 and 1.              |              |
| Variable     |                               |              |
+--------------+-------------------------------+--------------+
| Independent  | Observations are independent  | Assumed      |
| Observations | of each other.                |              |
+--------------+-------------------------------+--------------+
| Homo         | The variance of error terms   | Assumed      |
| scedasticity | are constant across levels of |              |
| of Error     | independent variables.        |              |
| Terms        |                               |              |
+--------------+-------------------------------+--------------+
| Linearity of | There are linear relationship | Met          |
| Predictors   | between logit of the expected |              |
...
| collinearity |                               |              |
+--------------+-------------------------------+--------------+
| No Outliers  | The data does not have        | Met          |
