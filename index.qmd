...
+==========+===========+:=========+==================================+
| GRE      | gre_score | 290 -    | Quantifies a candidate's         |
| Scores   |           | 340      | performance on the Graduate      |
|          |           |          | Record Examination, with a       |
|          |           | (340     | maximum score of 340             |
|          |           | scale)   |                                  |
+----------+-----------+----------+----------------------------------+
| TOEFL    | to        | 92 - 120 | Measures English language        |
| Scores   | efl_score |          | proficiency, scored out of a     |
|          |           | (120     | total of 120 points              |
|          |           | scale)   |                                  |
+----------+-----------+----------+----------------------------------+
| Un       | universi  | 1 to 5   | Rates universities on a scale    |
| iversity | ty_rating | with 5   | from 1 to 5, indicating their    |
| Rating   |           | being    | overall quality and reputation.  |
|          |           | the      |                                  |
|          |           | highest  |                                  |
|          |           | rating   |                                  |
+----------+-----------+----------+----------------------------------+
| S        | sop       | 1 to 5   | Evaluates the strength and       |
| tatement |           | with 5   | quality of a candidate's SOP on  |
| of       |           | being    | a scale of 1 to 5                |
| Purpose  |           | the      |                                  |
| (SOP)    |           | highest  |                                  |
| Strength |           | rating   |                                  |
+----------+-----------+----------+----------------------------------+
| Letter   | lor       | 1 to 5   | Evaluates the strength and       |
| of       |           | with 5   | quality of a candidate's SOP and |
| Reccomm  |           | being    | LOR on a scale of 1 to 5         |
| endation |           | the      |                                  |
| (LOR)    |           | highest  |                                  |
| Strength |           | rating   |                                  |
+----------+-----------+----------+----------------------------------+
| Under    | cgpa      | 6.8 -    | Reflects a student's academic    |
| graduate |           | 9.92     | performance in their             |
| GPA      |           |          | undergraduate studies, scored on |
|          |           | (10.0    | a 10-point scale                 |
|          |           | scale)   |                                  |
+----------+-----------+----------+----------------------------------+
| Research | research  | 0 or 1   | Indicates whether a candidate    |
| Ex       |           |          | has research experience (1) or   |
| perience |           |          | not (0).                         |
+----------+-----------+----------+----------------------------------+
| Chance   | chance    | 0.34 -   | Represents the likelihood of a   |
| of Admit | _of_admit | 0.97     | student being admitted,          |
|          |           |          | expressed as a decimal between 0 |
|          |           | (0 to 1  | and 1                            |
|          |           | scale)   |                                  |
+----------+-----------+----------+----------------------------------+
...
coefficients <- data.frame(
  Term = c("gre_score", "toefl_score", "university_rating", "sop", "lor", "cgpa", "research", "sop:lor"),
  Estimate = c(0.008720, 0.020909, 0.029896, -0.278052, -0.102987, 0.634843, 0.151620, 0.071630),
  Std_Error = c(0.003397, 0.006384, 0.029887, 0.073270, 0.075866, 0.068545, 0.045662, 0.021380)
)
