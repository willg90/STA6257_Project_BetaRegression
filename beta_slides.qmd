...
|               |               | proficiency, scored out of  |
|               | (120 scale)   | a total of 120 points       |
+---------------+---------------+-----------------------------+
| un iv         | 1 to 5 with 5 | Rates universities on a     |
| ersity_rating | being the     | scale from 1 to 5,          |
|               | highest       | indicating their overall    |
|               | rating        | quality and reputation.     |
+---------------+---------------+-----------------------------+
| sop           | 1 to 5 with 5 | E valuates the strength and |
|               | being the     | quality of a candidate's    |
|               | highest       | SOP on a scale of 1 to 5    |
|               | rating        |                             |
+---------------+---------------+-----------------------------+
| lor           | 1 to 5 with 5 | E valuates the strength and |
|               | being the     | quality of a candidate's    |
|               | highest       | SOP and LOR on a scale of 1 |
|               | rating        | to 5                        |
+---------------+---------------+-----------------------------+
| cgpa          | 6.8 - 9.92    | Reflects a student's        |
|               |               | academic performance in     |
|               | (10.0 scale)  | their undergraduate         |
|               |               | studies, scored on a        |
|               |               | 10-point scale              |
+---------------+---------------+-----------------------------+
| research      | 0 or 1        | Indicates whether a         |
|               |               | candidate has research      |
|               |               | experience (1) or not (0).  |
+---------------+---------------+-----------------------------+
| chance\_      | 0.34 - 0.97   | Represents the likelihood   |
| of_admit      |               | of a student being          |
|               | (0 to 1       | admitted, expressed as a    |
|               | scale)        | decimal between 0 and 1     |
+---------------+---------------+-----------------------------+
