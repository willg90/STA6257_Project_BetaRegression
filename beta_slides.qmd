...
+===============+:==============+===============================+
| gre_score     | 290 - 340     | Quantifies a candidate's      |
|               |               | performance on the Graduate   |
|               | (340 scale)   | Record Examination, with a    |
|               |               | maximum score of 340          |
+---------------+---------------+-------------------------------+
| toefl_score   | 92 - 120      | Measures English language     |
|               |               | proficiency, scored out of a  |
|               | (120 scale)   | total of 120 points           |
+---------------+---------------+-------------------------------+
| un iv         | 1 to 5 with 5 | Rates universities on a scale |
| ersity_rating | being the     | from 1 to 5, indicating their |
|               | highest       | overall quality and           |
|               | rating        | reputation.                   |
+---------------+---------------+-------------------------------+
| sop           | 1 to 5 with 5 | E valuates the strength and   |
|               | being the     | quality of a candidate's SOP  |
|               | highest       | on a scale of 1 to 5          |
|               | rating        |                               |
+---------------+---------------+-------------------------------+
| lor           | 1 to 5 with 5 | E valuates the strength and   |
|               | being the     | quality of a candidate's SOP  |
|               | highest       | and LOR on a scale of 1 to 5  |
|               | rating        |                               |
+---------------+---------------+-------------------------------+
| cgpa          | 6.8 - 9.92    | Reflects a student's academic |
|               |               | performance in their          |
|               | (10.0 scale)  | undergraduate studies, scored |
|               |               | on a 10-point scale           |
+---------------+---------------+-------------------------------+
| research      | 0 or 1        | Indicates whether a candidate |
|               |               | has research experience (1)   |
|               |               | or not (0).                   |
+---------------+---------------+-------------------------------+
| chance\_      | 0.34 - 0.97   | Represents the likelihood of  |
| of_admit      |               | a student being admitted,     |
|               | (0 to 1       | expressed as a decimal        |
...
-   First we split dataset for training and testing

## Choosing Best Fit Model {.scrollable}
...
-   Our model is specified as: chance_of_admit \~ gre_score +
    toefl_score + lor + cgpa + research."

-   "We used Maximum Likelihood Estimation (MLE) for fitting the beta
    regression model."
