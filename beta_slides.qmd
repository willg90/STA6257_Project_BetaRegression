...
|                     |                      | 120 points           |
+---------------------+----------------------+----------------------+
| un iv ersity_rating | 1 to 5 with 5 being  | Rates universities   |
|                     | the highest rating   | on a scale from 1 to |
|                     |                      | 5, indicating their  |
|                     |                      | overall quality and  |
|                     |                      | reputation.          |
+---------------------+----------------------+----------------------+
| sop                 | 1 to 5 with 5 being  | E valuates the       |
|                     | the highest rating   | strength and quality |
|                     |                      | of a candidate's SOP |
|                     |                      | on a scale of 1 to 5 |
+---------------------+----------------------+----------------------+
| lor                 | 1 to 5 with 5 being  | E valuates the       |
|                     | the highest rating   | strength and quality |
|                     |                      | of a candidate's SOP |
|                     |                      | and LOR on a scale   |
|                     |                      | of 1 to 5            |
...
|                     |                      | (1) or not (0).      |
+---------------------+----------------------+----------------------+
| chance\_ of_admit   | 0.34 - 0.97          | Represents the       |
|                     |                      | likelihood of a      |
|                     | (0 to 1 scale)       | student being        |
|                     |                      | admitted, expressed  |
